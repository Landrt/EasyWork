...
export async function getJobById(jobId: string): Promise<Job | null> {
  ...
  // Fallback mock job pour démo locale
  return {
    id: jobId,
    user_id: "demo-user-1",
    company_name: "ScaleUp IA",
    position_title: "Senior Staff Engineer",
    job_url: "https://scaleup-ia.example.com/careers/senior-staff-engineer",
    description: "Nous recherchons un Senior Staff Engineer pour piloter l'architecture de notre plateforme cloud d'IA générative et de microservices distribués. Maîtrise de Next.js, React 19, TypeScript, PostgreSQL et Kubernetes exigée.",
    location: "Paris, France (Hybride)",
    salary_range: "85k€ - 110k€",
    keywords: ["Next.js", "React 19", "TypeScript", "PostgreSQL", "Kubernetes", "Redis", "Docker", "IA Générative"],
