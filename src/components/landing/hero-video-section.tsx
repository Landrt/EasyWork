    ...
    <section className="relative py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12 max-w-3xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4 bg-gradient-to-r from-violet-600 via-blue-600 to-violet-600 bg-clip-text text-transparent">
          Découvrez EasyWork en Action
        </h2>
        <p className="text-muted-foreground text-lg">
          Découvrez comment notre plateforme propulsée par l&apos;IA transforme vos candidatures en quelques minutes
        </p>
      </div>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-6xl border-0 bg-transparent p-0">
          ...
          <DialogDescription className="sr-only">
            Découvrez comment EasyWork optimise vos candidatures grâce à l&apos;IA
          </DialogDescription>
